...
class Server(LoggerMixIn):
    ...
    def shutdown(self, process_queue: bool=True, timeout: float=None) -> \
            None: ...
    ...
    def _start_queue_processor(self, processor: QueueProcessor) -> QueueProcess: ...
    def _share_queue(self) -> None: ...
    def _shutdown_queue_processor(self, processor: QueueProcessor, process: bool=True,
                                  timeout: float=None): ...
    def _start_collecting(self, collectors: Iterable[AbstractCollector]) -> None: ...
    def _shutdown_collectors(self, collectors: Iterable[AbstractCollector], timeout: float=None) -> None: ...
